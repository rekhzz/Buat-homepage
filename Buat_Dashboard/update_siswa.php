...
<head>
    ...
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      <a href="Dashboard.html" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
...
<div class="container">
	<div class="card mt-3">
		<div class="card-header bg-primary text-white"> UBAH DATA SISWA </div> 
					...
					<input type="hidden" name="id" value="<?= $querysiswa["id"]; ?>">
							<div class="row">
											<div class="mb-3" align="">
												...
												<input class="form-control" type="text" name="nis" id="nis" required value="<?= $querysiswa["nis"]; ?>">	
											</div>
											<div class="mb-3" align="">
												<label class="form-label" for="nama_siswa">Nama :</label>
												<input class="form-control" type="text" name="nama_siswa" id="nama_siswa" value="<?= $querysiswa["nama_siswa"]; ?>">	
											</div>
											<div class="mb-3" align="">
												<label class="form-label" for="tanggal_lahir">Tanggal Lahir :</label>
												<input class="form-control" type="text" name="tanggal_lahir" id="tanggal_lahir" value="<?= $querysiswa["tanggal_lahir"]; ?>">	
											</div>
											<div class="mb-3" align="">
												<label class="form-label" for="jenis_kelamin">Jenis Kelamin :</label>
												<input class="form-control" type="text" name="jenis_kelamin" id="jenis_kelamin" value="<?= $querysiswa["jenis_kelamin"]; ?>">	
											</div>
											<div class="mb-3" align="">
